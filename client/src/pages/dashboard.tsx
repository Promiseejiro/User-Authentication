...
const Dashboard = () => {
  ...
  const fetchUser = async () => {
    ...
    const { email, password, bio, phone, avarta, name } =
      await authenticatedUser.data.user;
  ...
  return (
    <div className="pt-4 px-4">
      <div className="flex items-center justify-between">
        <Logo />
        <img
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQlL5HN0XpETGacd8fMtz-dHqTLFN3BBJcvQg&usqp=CAU"
          className="h-auto w-[4rem] rounded-[5px]"
        />
      </div>
      ...
      <div className="border-b-[gray] lg:border-b-solid border-2px rounded-[10px] overflow-hidden">
        ...
        <div className="flex items-center justify-between p-4 border-[gray] border-solid border-b-1">
          ...
          <img
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQlL5HN0XpETGacd8fMtz-dHqTLFN3BBJcvQg&usqp=CAU"
            className="h-auto w-[5rem] rounded-[5px]"
          />
        </div>
