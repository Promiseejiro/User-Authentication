...
const Register = () => {
  ...
  return (
    <div className="p-4">
      <Logo />
      <Header
        text="Join thousands of learner around the world"
        align="left"
        marginY="1rem"
      />
      <Text
        text="Master web development by making real life projects. There are multiple path for you to choose."
        color="red"
      />
      <Input
        placeholder="Email"
        icon={<AiOutlineCheckCircle style={{ color: "gray" }} />}
        marginY="1rem"
        name="email"
        onchange={onchange}
      />
      ...
      <p className="text-center text-[gray] my-5">
        Are you a member already ? <a className="text-[#2f80ed]">Login</a>
      </p>
